...
time('Write file')
/**
 * Запись объекта с итоговыми координатами городов в файл
 * @param {object} coord - Объект содержащий координаты городов, где ключ - название города, значение массив с координатами
 * @example { "Сочи": [43.602, 39.734], "Махачкала": [42.977, 47.514],}
 */
